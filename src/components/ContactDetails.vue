  ...
  <div v-if="isInEditMode" class="card">
    <div class="card-header btn">
      <div class="row justify-content-between">
        ...
        <div class="col-2">
          <button v-on:click="saveEdit" class="btn btn-sm btn-success">Modifier</button>
        </div>
        <div class="col-2">
          <button v-on:click="cancelEdit" class="btn btn-sm btn-danger">Annuler</button>
        </div>
      </div>
    </div>
